    ...
    <Card title="Estimated Earnings (COIN/BTC/USD)">
      <div className="row">
        ...
        <div className="col-sm-12 col-md-9">
          { nbtc(day) } TWINS / { nbtc(day * coin.btc) } BTC / { nusd(day * coin.usd) } USD
        </div>
      </div>
      <div className="row">
        <div className="col-sm-12 col-md-3">
        ...
        <div className="col-sm-12 col-md-9">
          { nbtc(week) } TWINS / { nbtc(week * coin.btc) } BTC / { nusd(week * coin.usd) } USD
        </div>
      </div>
      <div className="row">
        <div className="col-sm-12 col-md-3">
        ...
        <div className="col-sm-12 col-md-9">
          { nbtc(month) } TWINS / { nbtc(month * coin.btc) } BTC / { nusd(month * coin.usd) } USD
        </div>
      </div>
      <div className="row">
        <div className="col-sm-12 col-md-3">
        ...
        <div className="col-sm-12 col-md-9">
          { nbtc(year) } TWINS / { nbtc(year * coin.btc) } BTC / { nusd(year * coin.usd) } USD
        </div>
      </div>
      <div className="row">
        <div className="col">
