...
const CardROI = ({ coin, supply }) => {
  ...
  return (
    <Card>
      ...
      <div className="mb-3">
        <div className="h3">
          { numeral(supply ? supply.t : 0.0).format('0,0.0000') } TWINS
        </div>
        <div className="h5">
          Coin Supply (Total)
        </div>
      ...
      <div className="mb-3">
        <div className="h3">
          { numeral(supply ? supply.c - (mns * mncoins) : 0.0).format('0,0.0000') } TWINS
        </div>
        <div className="h5">
      ...
      <div className="mb-3">
        <div className="h3">
          { numeral(coin.cap * coin.btc * 10).format('0,0.0000') } BTC
        </div>
        <div className="h5">
          Market Cap BTC
        </div>
      ...
      <div className="mb-3">
        <div className="h3">
          { numeral(mns * mncoins).format('0,0.0000') } TWINS
        </div>
        <div className="h5">
          Coins Locked
        </div>
